...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_MotifUtils.UploadFromJASPAR,
                             name='MotifUtils.UploadFromJASPAR',
                             types=[dict])
        self.method_authentication['MotifUtils.UploadFromJASPAR'] = 'required'  # noqa
        self.rpc_service.add(impl_MotifUtils.UploadFromTRANSFAC,
                             name='MotifUtils.UploadFromTRANSFAC',
                             types=[dict])
        self.method_authentication['MotifUtils.UploadFromTRANSFAC'] = 'required'  # noqa
        ...
        self.rpc_service.add(impl_MotifUtils.importFromNarrative,
                             name='MotifUtils.importFromNarrative',
                             types=[dict])
        self.method_authentication['MotifUtils.importFromNarrative'] = 'required'  # noqa
